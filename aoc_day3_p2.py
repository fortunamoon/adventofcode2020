...
def parse_data():
    ...
    for item in puzzle_raw_data:
        ...
        if temp_password[policy_begin] == temp_key and temp_password[policy_end] != temp_key or temp_password[policy_begin] != temp_key and temp_password[policy_end] == temp_key:
            valid_policies += 1
